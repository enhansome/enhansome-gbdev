# Awesome Game Boy Development with stars
...
A curated list of awesome Game Boy (Color) Development resources, tools, docs, related projects and open-source ROMs. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,008 | 🐛 106 | 📅 2026-09-02 list thing.
...
> #### Game Boy Advance
>
> Game Boy Advance development is covered by another project, the [awesome-gbadev](https://github.com/gbdev/awesome-gbadev) ⭐ 1,337 | 🐛 6 | 📅 2026-01-30 list.
...
* [The Cycle-Accurate Game Boy Docs](https://github.com/AntonioND/giibiiadvance/blob/master/docs/TCAGBD.pdf) ⭐ 214 | 🐛 0 | 🌐 C | 📅 2026-01-25 - A precise documentation by AntonioND to make a cycle-accurate Game Boy emulator.
...
* [Related custom hardware](https://github.com/Gekkio/gb-hardware) ⭐ 375 | 🐛 1 | 🌐 Shell | 📅 2023-07-20 - by Gekkio.
...
* [dmg-schematics](https://github.com/msinger/dmg-schematics) ⭐ 48 | 🐛 2 | 🌐 KiCad Schematic | 📅 2026-08-21 - Schematics and annotated overlay for the DMG-CPU B chip, extracted from die photos, made with KiCad. Also contains Electric VLSI library with layouts for some of the cells and memories.
...
* [Edge of Emulation](https://shonumi.github.io/articles.html), a series of articles about emulating and investigating Game Boy accessories. Also available as [technical documents](https://github.com/shonumi/gbe-plus/tree/master/src/docs/technical) ⭐ 599 | 🐛 81 | 🌐 C++ | 📅 2026-08-24 in the GBE- emulator documentation.
...
* [Arduino Game Boy Printer Emulator](https://github.com/mofosyne/arduino-gameboy-printer-emulator) ⭐ 366 | 🐛 3 | 🌐 C++ | 📅 2026-05-13 - Emulating a Game Boy Printer via the Game Boy Link cable with an Arduino.
...
* [AntonioND's docs](https://github.com/AntonioND/giibiiadvance/tree/master/docs) ⭐ 214 | 🐛 0 | 🌐 C | 📅 2026-01-25 - Corrected schematics and infos on cartridge header data.
...
* [Homebrew-Gameboy-Cartridge](https://github.com/dwaq/Homebrew-Gameboy-Cartridge) ⭐ 138 | 🐛 0 | 📅 2020-02-13 - Eagle library, schematic, and board files for a cartridge PCB using an Atmel AT49F040 as ROM.
...
* [GBSOUND.txt](https://github.com/bwhitman/pushpin/blob/master/src/gbsound.txt) ⭐ 57 | 🐛 1 | 🌐 C | 📅 2021-07-12 - A document detailing the Game Boy sound engine.
...
* [Emulation of Nintendo Game Boy](https://github.com/Baekalfen/PyBoy/blob/master/extras/PyBoy.pdf) ⭐ 5,195 | 🐛 21 | 🌐 Python | 📅 2026-08-28 - Overview of the Game Boy hardware with the perspective of building an emulator.
* [Game Boy Doctor](https://github.com/robert/gameboy-doctor) ⭐ 285 | 🐛 6 | 🌐 Python | 📅 2024-10-06 - A command line tool for comparing logs from your emulator to those from a known-correct one. Useful for line-by-line debugging of Blargg's test ROMs.
...
* [dmg-acid2](https://github.com/mattcurrie/dmg-acid2) ⭐ 239 | 🐛 6 | 🌐 Assembly | 📅 2024-05-23 and [cgb-acid2](https://github.com/mattcurrie/cgb-acid2) ⭐ 88 | 🐛 1 | 🌐 Assembly | 📅 2021-02-26 - Basic PPU rendering tests.
...
* [MBC3 RTC test ROM](https://github.com/aaaaaa123456789/rtc3test) ⭐ 41 | 🐛 1 | 🌐 Assembly | 📅 2022-12-03
...
* [RGBDS](https://github.com/gbdev/rgbds) ⭐ 1,642 | 🐛 84 | 🌐 C++ | 📅 2026-09-03 - Assembler and linker package. [Documentation](https://rgbds.gbdev.io).
* [wla-dx](https://github.com/vhelin/wla-dx) ⭐ 608 | 🐛 27 | 🌐 C | 📅 2026-08-29 - Yet Another GB-Z80/Z80/... Multi Platform Cross Assembler Package. [Documentation](http://www.villehelin.com/wla.txt).
* [ASMotor](https://github.com/csoren/asmotor) ⭐ 90 | 🐛 3 | 🌐 C | 📅 2026-07-31 - Assembler engine and development system targeting Game Boy, among other CPUs. Written by the original RGBDS author. [Documentation](https://github.com/asmotor/asmotor/tree/develop#further-reading) ⭐ 90 | 🐛 3 | 🌐 C | 📅 2026-07-31.

### Compilers

* [GBDK](https://github.com/gbdk-2020/gbdk-2020/) ⭐ 2,292 | 🐛 11 | 🌐 C | 📅 2026-08-24 - Maintained and modernized GBDK (Game Boy Development Kit) powered by an updated version of the SDCC toolchain. Provides a C compiler, assembler, linker and a set of libraries.
...
* [Wiz](https://github.com/wiz-lang/wiz) ⭐ 437 | 🐛 76 | 🌐 C++ | 📅 2025-04-10 - A high-level assembly language for writing homebrew on retro console platforms (Game Boy, NES, Atari 2600, and more).
* [Rust-GB](https://github.com/zlfn/rust-gb) ⭐ 334 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - A compiler and library that enable the development of GB ROMs using Rust.
...
* [mGBA](https://github.com/mgba-emu/mgba) ⭐ 7,354 | 🐛 851 | 🌐 C | 📅 2026-08-31 - Modern cross platform GBA emulator which also runs GB/GBC games.

* [SameBoy](https://github.com/LIJI32/SameBoy) ⭐ 2,187 | 🐛 167 | 🌐 C | 📅 2026-07-10 - Accurate emulator with a wide range of powerful debugging features.

* [MetroBoy](https://github.com/aappleby/MetroBoy) ⭐ 1,170 | 🐛 4 | 🌐 C++ | 📅 2025-02-23 - A playable, circuit-level simulation of an entire Game Boy.

* [Mooneye GB](https://github.com/Gekkio/mooneye-gb) ⭐ 971 | 🐛 43 | 🌐 Rust | 📅 2023-03-16 - Research project and emulator in Rust.

* [Binjgb](https://github.com/binji/binjgb) ⭐ 606 | 🐛 14 | 🌐 C | 📅 2026-07-04 - 5Kloc emulator that passes most of the tests. \*Rewind- feature. Runs in the browser using WebAssembly.

* [gbe-plus](https://github.com/shonumi/gbe-plus) ⭐ 599 | 🐛 81 | 🌐 C++ | 📅 2026-08-24 - A recently rewritten emulator that has a large effort in preserving the functions of obscure accessories (such as IR link, Mobile Network GB, Barcode Boy, GB Printer, local and online GB Serial Link Cable, ... )

* [Gambatte](https://github.com/gb-archive/gambatte) ⭐ 8 | 🐛 0 | 🌐 Assembly | 📅 2021-07-06 - Cross-platform and accurate emulator.
...
* [ZGB](https://github.com/Zal0/ZGB) ⭐ 789 | 🐛 10 | 🌐 C++ | 📅 2024-08-01 - A little engine for creating games for the original Game Boy (expands gbdk, more info [here](http://zalods.blogspot.com/2017/01/zgb-little-engine-for-game-boy.html)).
...
* [evscript](https://github.com/eievui5/evscript) ⚠️ Archived - A scripting language for the Game Boy, useful for enemy AI, dialogue, animations, and coroutines.
...
* [Game Boy Text Tools](https://github.com/raphaklaus/gameboy-text-tools) ⭐ 12 | 🐛 1 | 🌐 JavaScript | 📅 2017-12-02 - Set of tools for text manipulation and translation of Game Boy ROMs written in Node.js.
...
* [Tilemap Studio](https://github.com/Rangi42/tilemap-studio) ⭐ 531 | 🐛 26 | 🌐 C++ | 📅 2026-05-02 - A tilemap editor for Game Boy, Color, Advance, and SNES projects. Written in C++ with FLTK.
* [Superfamiconv](https://github.com/Optiroc/SuperFamiconv) ⭐ 190 | 🐛 21 | 🌐 C++ | 📅 2026-09-04 - Flexible and composable tile graphics converter supporting Super Nintendo, Game Boy, Game Boy Color, Game Boy Advance, Mega Drive and PC Engine formats.
...
* [Game Boy LCD sniffing](https://github.com/svendahlstrand/game-boy-lcd-sniffing) ⭐ 184 | 🐛 0 | 🌐 C | 📅 2017-08-11 - Sniff your Game Boy's LCD using a logic analyzer.
* [gbcamextract](https://github.com/jkbenaim/gbcamextract) ⭐ 53 | 🐛 0 | 🌐 C | 📅 2022-05-08 - Extracts photos from Game Boy Camera saves.
* [cart-dumper](https://github.com/Palmr/cart-dumper) ⭐ 46 | 🐛 0 | 🌐 Assembly | 📅 2018-07-09 - Game Boy Cartridge Dumper ROM.
...
* [hUGETracker](https://github.com/SuperDisk/hUGETracker) ⭐ 367 | 🐛 37 | 🌐 Pascal | 📅 2026-08-25 - A music tracker based on OpenMPT, focused on ease of use, compact output, and embeddability in homebrew games.
...
* [GBSoundSystem](https://github.com/gbdev/GBSoundSystem) ⭐ 20 | 🐛 0 | 🌐 Assembly | 📅 2023-05-09 - A modernized audio driver for GameBoy Tracker (aka the Paragon 5 music player).
...
* [hardware.inc](https://github.com/tobiasvl/hardware.inc) ⭐ 161 | 🐛 5 | 🌐 Assembly | 📅 2026-08-28 - Standard include file containing Game Boy hardware definitions for use in RGBDS projects.
...
* [DMGreport](https://github.com/lancekindle/DMGreport) ⭐ 63 | 🐛 1 | 🌐 Assembly | 📅 2024-09-01 - Game programming tutorials in assembly.
...
* [DeadCScroll](https://github.com/gb-archive/DeadCScroll) ⭐ 28 | 🐛 0 | 📅 2021-04-17 - A detailed tutorial on how to make the screen wobble, among other "raster effects"
...
* [GingerBread](https://github.com/ahrnbom/gingerbread) ⭐ 139 | 🐛 2 | 🌐 Assembly | 📅 2021-01-19 - A software library for making your own Game Boy games. It is made to be used alongside the book [Game Boy Assembly Programming for the Modern Game Developer](https://github.com/ahrnbom/gbapfomgd) ⭐ 166 | 🐛 0 | 🌐 TeX | 📅 2023-02-25 which also doubles as documentation.
...
* [bootstrap.gb](https://github.com/yenatch/bootstrap.gb) ⭐ 33 | 🐛 4 | 🌐 Assembly | 📅 2024-05-31 - An example Game Boy project.
* [Gameboy Boilerplate](https://github.com/junebug12851/GameboyBoilerplateProj) ⭐ 30 | 🐛 0 | 🌐 Assembly | 📅 2020-07-15 - Boilerplate project to move quicker into the actual assembly code for your game.
...
* [Z80 Assembly support for Visual Studio Code](https://github.com/Imanolea/z80asm-vscode) ⭐ 37 | 🐛 0 | 📅 2025-08-16
...
* [Simplified GBDK examples](https://github.com/mrombout/gbdk_playground) ⭐ 205 | 🐛 1 | 🌐 C | 📅 2025-09-30
* [Grooves Game Boy Programming](https://github.com/gbdk-salvage/grooves-game-boy-programming) ⭐ 91 | 🐛 2 | 🌐 C | 📅 2023-03-30 - A complete set of lessons about implementing various game mechanics in a Game Boy game.
* [8-Bit Wonderland](https://github.com/gb-archive/salvage/blob/master/misc/8bit_wonderland.pdf) ⭐ 42 | 🐛 2 | 🌐 HTML | 📅 2025-04-22 - Well-written introductory document about how the Game Boy works and how to start developing working code for it.
...
* [superhappyfunbubbletime](https://github.com/l0k1/superhappyfunbubbletime) ⭐ 6 | 🐛 0 | 🌐 Assembly | 📅 2020-02-19
...
* [Powa!](https://aiguanachein.itch.io/powa) - Side scrolling platformer for the Game Boy (Color)  ([ZGB engine](https://github.com/Zal0/ZGB/) ⭐ 789 | 🐛 10 | 🌐 C++ | 📅 2024-08-01).
* [Cavern](https://thegreatgallus.itch.io/cavern-mvm-9) - ([ZGB engine](https://github.com/Zal0/ZGB/) ⭐ 789 | 🐛 10 | 🌐 C++ | 📅 2024-08-01).
* [Mona and the Witch's Hat Deluxe](https://ctneptune.itch.io/mona-and-the-witchs-hat-dx) - ([ZGB engine](https://github.com/Zal0/ZGB/) ⭐ 789 | 🐛 10 | 🌐 C++ | 📅 2024-08-01).
* [Tobu Tobu Girl Deluxe](https://github.com/SimonLarsen/tobutobugirl-dx) ⭐ 97 | 🐛 1 | 🌐 C | 📅 2023-01-29 - An arcade platformer for the Game Boy (Color).
...
* [Evoland.gb](https://github.com/flozz/evoland.gb) ⭐ 45 | 🐛 0 | 🌐 C | 📅 2019-04-21 - A port of the first level of Evoland.
* [gb-mines](https://github.com/andreasjhkarlsson/gb-mines) ⭐ 37 | 🐛 2 | 🌐 C | 📅 2018-05-06
* [Petris](https://github.com/bbbbbr/Petris) ⭐ 35 | 🐛 0 | 🌐 C | 📅 2026-09-02 - A puzzle game of shapely pets for the Game Boy Color ([itch.io](https://bbbbbr.itch.io/petris)).
* [GBsnake](https://github.com/brovador/GBsnake) ⭐ 32 | 🐛 0 | 🌐 C++ | 📅 2017-04-23
* [Super Princess' 2092 Exodus](https://github.com/Zal0/gbjam2016) ⭐ 30 | 🐛 0 | 🌐 C | 📅 2022-11-02 - ([ZGB engine](https://github.com/Zal0/ZGB/) ⭐ 789 | 🐛 10 | 🌐 C++ | 📅 2024-08-01).
...
* [GB raycaster, Vision-8](https://github.com/haroldo-ok/really-old-stuff/tree/master/gameboy) ⭐ 14 | 🐛 0 | 🌐 C | 📅 2017-11-02 - and some other projects.
...
* [totp-gb](https://github.com/dmang-dev/totp-gb) ⭐ 4 | 🐛 0 | 🌐 C | 📅 2026-08-18 - TOTP (RFC 6238) two-factor authenticator with SGB border, GBC palettes and an MBC3 RTC clock.
...
* [GBVideoPlayer2](https://github.com/LIJI32/GBVideoPlayer2) ⭐ 134 | 🐛 7 | 🌐 C | 📅 2019-11-02 - The second iteration of the above demo, which increases the resolution, adds *stereo- PCM audio, and introduces video compression*.
* [GBVideoPlayer](https://github.com/LIJI32/GBVideoPlayer) ⭐ 105 | 🐛 4 | 🌐 Python | 📅 2018-02-26 - A technical demo demonstrating how the Game Boy LCD controller can be hacked to make a Game Boy Color play a full motion video in color, together with music.
* [CUTE DEMO](https://github.com/mills32/CUTE_DEMO) ⭐ 40 | 🐛 1 | 🌐 C | 📅 2020-06-17
...
* [`10 PRINT` Game Boy](https://github.com/svendahlstrand/10-print-game-boy) ⭐ 29 | 🐛 0 | 🌐 Assembly | 📅 2018-07-30
...
* [Pokémon Red/Blue](https://github.com/pret/pokered) ⭐ 4,909 | 🐛 22 | 🌐 Assembly | 📅 2026-08-27
* [Pokémon Crystal](https://github.com/pret/pokecrystal) ⭐ 2,496 | 🐛 59 | 🌐 Assembly | 📅 2026-08-28
* [Link's Awakening DX](https://github.com/mojobojo/LADX-Disassembly) ⭐ 899 | 🐛 18 | 🌐 Assembly | 📅 2026-08-27
* [Pokémon Yellow](https://github.com/pret/pokeyellow) ⭐ 873 | 🐛 3 | 🌐 Assembly | 📅 2026-09-02
* [Pokémon Gold and Silver](https://github.com/pret/pokegold) ⭐ 712 | 🐛 4 | 🌐 Assembly | 📅 2026-08-13
* [pokegold-spaceworld](https://github.com/pret/pokegold-spaceworld) ⭐ 393 | 🐛 2 | 🌐 Assembly | 📅 2026-09-02 - Pokémon Gold and Silver 1997 Space World demo.
* [Pokémon TCG](https://github.com/pret/poketcg) ⭐ 325 | 🐛 7 | 🌐 Assembly | 📅 2026-08-13
...
* [The Jungle Book](https://github.com/not-chciken/jungle-book-gb-disassembly) ⭐ 4 | 🐛 0 | 🌐 Assembly | 📅 2026-05-21
...
* [Arduino Gameboy Printer Emulator](https://github.com/mofosyne/arduino-gameboy-printer-emulator) ⭐ 366 | 🐛 3 | 🌐 C++ | 📅 2026-05-13 - Emulate a gameboy printer via the gameboy link cable.
* [WiFi GBP Emulator](https://github.com/HerrZatacke/wifi-gbp-emulator) ⭐ 78 | 🐛 1 | 🌐 C++ | 📅 2026-04-10 - A GameBoy printer emulator which provides the received data over a WiFi connection.
...
* [Game Boy WiFi Printer - D1 Mini Shield](https://github.com/cristofercruz/gbp-esp-shield-pcb) ⭐ 25 | 🐛 0 | 📅 2021-08-31 - Game Boy Printer interface shield for D1 mini/mini Pro ESP8266 boards.
...
* [game-boy-camera-frame-replacer](https://github.com/cristofercruz/game-boy-camera-frame-replacer) ⭐ 42 | 🐛 0 | 🌐 Python | 📅 2024-04-28 - Manipulate the ROM of a camera to include custom frames
...
* [Game Boy Printer Paper Simulation](https://github.com/mofosyne/GameboyPrinterPaperSimulation) ⭐ 83 | 🐛 0 | 🌐 C++ | 📅 2026-09-01 - Generate as-if-printed images of digital printed images.
* [Game Boy Printer Web](https://github.com/HerrZatacke/gb-printer-web) ⭐ 76 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-02 - Gallery app for to the Game Boy camera: import pictures from exports or cartridge dumps and choose color palettes.

## Related projects

* [VerilogBoy](https://github.com/zephray/VerilogBoy/) ⭐ 542 | 🐛 5 | 🌐 Verilog | 📅 2022-12-10 - Game Boy compatible console Verilog RTL implementation.
* [ArduinoBoy](https://github.com/trash80/Arduinoboy) ⭐ 370 | 🐛 8 | 🌐 Max | 📅 2020-11-16 - Serial communication (MIDI) from an Arduino to the Game Boy for music applications such as LittleSoundDJ, Nanoloop, and mGB.
* [mGB](https://github.com/trash80/mGB) ⭐ 271 | 🐛 15 | 🌐 Assembly | 📅 2024-07-16 - A Game Boy cartridge program that enables the Game Boy to act as a full MIDI supported sound module.
...
* [gb-save-states](https://github.com/mattcurrie/gb-save-states) ⭐ 189 | 🐛 31 | 🌐 Assembly | 📅 2025-02-18 - Patches to add save state support to Game Boy games when playing on the original hardware.
...
* [GBxCart-RW](https://github.com/insidegadgets/GBxCart-RW) ⭐ 107 | 🐛 4 | 🌐 C | 📅 2022-12-29 - A device for reading game ROMs, save games and restoring saves for GB, GBC and GBA carts from your PC via USB.
* [Game Boy Link Cable Breakout Board](https://github.com/Palmr/gb-link-cable) ⭐ 106 | 🐛 0 | 📅 2022-08-18
* [fpgaboy](https://github.com/trun/fpgaboy) ⭐ 100 | 🐛 3 | 🌐 Verilog | 📅 2016-09-10 - Implementation Nintendo's Game Boy console on an FPGA.
* [GBCamcorder](https://github.com/furrtek/GBCamcorder) ⭐ 97 | 🐛 3 | 🌐 C | 📅 2021-12-20 - Lo-Fi portable video recorder using a GameBoy Camera cartridge.
...
* [Piglet](https://github.com/danShumway/Piglet) ⭐ 45 | 🐛 3 | 🌐 Lua | 📅 2014-12-08 - A LUA-driven AI that plays classic Game Boy color games using experimentation. In active development.
* [Ostrich](https://github.com/PumpMagic/ostrich) ⭐ 43 | 🐛 0 | 🌐 Swift | 📅 2017-06-09 - A Game Boy Sound System player written in Swift.
* [GBVisualizer](https://github.com/LIJI32/GBVisualizer) ⭐ 29 | 🐛 0 | 🌐 Assembly | 📅 2017-04-14 - Demonstrating the use of two undocumented Game Boy Color registers, nicknamed PCM12 (FF76) and PCM34 (FF77), which can be used to read the current PCM amplitude of the 4 APU channels.
...
* [The Game Boy Archive - Salvage](https://github.com/gb-archive/salvage) ⭐ 42 | 🐛 2 | 🌐 HTML | 📅 2025-04-22 - Historical archive of software, old articles, FAQs and various documents.
...
Thanks to [every](https://github.com/avivace/awesome-gbdev/graphs/contributors) ⭐ 4,496 | 🐛 21 | 📅 2026-07-22 contributor of this project, Jeff Frohwein, Pascal Felber, KOOPa, Pan of Anthrox, GABY, Marat Fayzullin, Paul Robson, BOWSER, neviksti, Martin "nocash" Korth, Nitro2k01, Duo, Chris Antonellis, Michael Hope, Beware, Jonathan “Lord Nightmare” Gevaryahu, Carsten Sorense, Sindre Aamås, Otaku No Zoku, GeeBee.
